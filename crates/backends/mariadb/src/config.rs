...
impl Config {
    ...
    /// Resolves connection and schema fields into a concrete MariaDB source.
    ///
    /// # Errors
    ///
    ...
    ) -> Result<MariaDbSource, E> {
        let mut source = MariaDbSource::new(id, resolve_value(&self.url)?);
